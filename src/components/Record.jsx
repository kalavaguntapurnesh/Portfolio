...
const Record = () => {
  ...
  return (
    ...
    >
      <div className="pt-16 pb-4 bg-white dark:bg-[#000300]">
                  ...
                  <div className="grid md:grid-cols-4 grid-cols-2 md:gap-8 gap-8 mx-auto justify-center items-center content-center">
                    <div className=" flex flex-col gap-1">
                      <div className=" h-12 flex justify-center items-center">
                        <h4 className="font-bold text-5xl text-green-500 tracking-wider">
                          {counterOn && (
                            <CountUp
                              start={0}
                              end={6}
                      ...
                      <div className=" h-20 flex justify-center items-center">
                        <h4 className="font-bold tracking-wide leading-relaxed md:text-base text-sm dark:text-white text-headingColor">
                    ...
                    <div className=" flex flex-col gap-1">
                      <div className=" h-12 flex justify-center items-center tracking-wider">
                        <h4 className="font-bold text-5xl text-green-500">
                          {counterOn && (
                            <CountUp
                              start={0}
                              end={100}
